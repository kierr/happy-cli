 ...
 * and sends OpenCodeDiff tool calls when the diff changes from its previous value.
 */
...
export class DiffProcessor {
    ...
    processDiff(unifiedDiff: string): void {
        ...
        if (this.previousDiff !== unifiedDiff) {
            logger.debug('[DiffProcessor] Unified diff changed, sending OpenCodeDiff tool call');
