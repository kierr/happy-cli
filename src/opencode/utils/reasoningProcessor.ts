...
export class ReasoningProcessor {
    ...
    /**
     * Complete reasoning section with final text
     */
    complete(fullText: string): void {
        ...
        if (title && !this.toolCallStarted) {
            // If we have a title but haven't sent tool call yet, send it now
    ...
    /**
     * Abort current reasoning section
     */
    abort(): void {
    ...
    /**
     * Get current call ID for tool result matching
     */
