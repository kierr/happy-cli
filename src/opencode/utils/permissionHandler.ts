/**
 * Permission Handler for OpenCode tool approval integration
 *
 * Handles tool permission requests and responses for OpenCode sessions.
...
export class OpenCodePermissionHandler {
    ...
    async handleToolCall(
        ...
        return new Promise<PermissionResult>((resolve, reject) => {
            ...
            logger.debug(`[OpenCode] Permission request sent for tool: ${toolName} (${toolCallId})`);
        });
    }
    ...
    private setupRpcHandler(): void {
        this.session.rpcHandlerManager.registerHandler<PermissionResponse, void>(
            ...
            async (response) => {
                ...
                if (!pending) {
                    logger.debug('[OpenCode] Permission request not found or already resolved');
                    return;
                }
    ...
    reset(): void {
        ...
        logger.debug('[OpenCode] Permission handler reset');
    }
}